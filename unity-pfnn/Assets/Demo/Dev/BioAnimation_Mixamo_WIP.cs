...
// 			// rest = 1f;
// 			translationalOffset = new Vector3(rootMotion.x, 0f, rootMotion.z);
// 			rotationalOffset = rootMotion.y;

// 			Trajectory.Points[RootPointIndex].SetPosition(translationalOffset.GetRelativePositionFrom(currentRoot));
// 			// Debug.Log(translationalOffset.GetRelativePositionFrom(currentRoot));
// 			Debug.Log(rest);
