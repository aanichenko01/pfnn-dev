...
namespace PFNN_DEV
{
	...
	public class BioAnimation_F42_3Styles : MonoBehaviour
	{
...
#if UNITY_EDITOR
		[CustomEditor(typeof(BioAnimation_F42_3Styles))]
		public class BioAnimation_F42_3Styles_Editor : Editor
		{

			public BioAnimation_F42_3Styles Target;

			void Awake()
			{
				Target = (BioAnimation_F42_3Styles)target;
			}
