...
namespace PFNN_DEV {
	...
	public class BioAnimation_F42 : MonoBehaviour {
		...
		#if UNITY_EDITOR
		[CustomEditor(typeof(BioAnimation_F42))]
		public class BioAnimation_F42_Editor : Editor {

			public BioAnimation_F42 Target;

			void Awake() {
				Target = (BioAnimation_F42)target;
			}
