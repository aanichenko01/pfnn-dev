...
namespace PFNN_DEV
{
	...
	public class BioAnimation_F42_2Styles : MonoBehaviour
	{
...
#if UNITY_EDITOR
		[CustomEditor(typeof(BioAnimation_F42_2Styles))]
		public class BioAnimation_F42_2Styles_Editor : Editor
		{

			public BioAnimation_F42_2Styles Target;

			void Awake()
			{
				Target = (BioAnimation_F42_2Styles)target;
			}
